...
# [1] ETF 건은 '익스포저가 있는 상태'를 전제로 한다.
# 익스포저가 없으면 regrade가 참고로 강등하면서 customer_notice를 지우는데,
# 이는 보유 고객이 없으니 안내도 불필요하다는 정상 동작이다. 8/17 실사례는
# 뱅키스 47억 보유 건이었으므로 그 조건을 만들어 준다. 운영 CSV에 그때그때
# 어떤 ETF가 실려 있는지에 시뮬 결과가 좌우되지 않게 하려는 목적도 있다.
_SIM_ETF = "TIME 미국배당다우존스액티브"
exposure_data.setdefault(_SIM_ETF, [{
    "기준일": ref_date or "2026-08-20", "종목명": _SIM_ETF, "종목코드": "999999",
    "종목유형": "주식", "뱅잔고": "47", "뱅고객수": "765",
    "영잔고": "7", "영고객수": "114", "잔고(억)": "54", "고객수": "879",
